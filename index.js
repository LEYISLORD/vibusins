...
case 'creador': 
case 'developer':
   //Fg.sendContact(from, '51959393283', 'VIBU', mek) 
   m.reply(`
*≡ OWNER*

▢ Instagram :
  • https://instagram.com/bossxvibu▢ WhatsApp : 
  • wa.me/
▢ Telegram : 
  • t.me/fgsupp_bot 
  • t.me/fg98ff (canal)
...
*≡ OWNER*
▢ Instagram : https://www.instagram.com/bossxvibu
▢ WhatsApp : wa.me/

*≡ SCRIPT*
▢ Git : ${package.homepage} 
` 
Fg.send2Button(from, teks, '*_@bossxvibu_*', `ꨄ︎ Apoyar`, `${prefix}donate`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
   break
...
Fg.send2ButtonLoc(from, welm, capt, 'Sígueme en Instagram\nhttps://www.instagram.com/bossxvibu', '⦙☰ MENU', '/menu', '⏍ INFO GP', '/infogp', false, {
	      contextInfo: { 
            mentionedJid: Fg.parseMention(capt)
	      } 
	    }); //--
